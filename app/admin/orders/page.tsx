                          ...
                          <>
                            <tr key={o.id} className={"border-b border-gray-100 " + (selectedOrderIds.has(o.id) ? "bg-blue-100" : i % 2 === 0 ? "" : "bg-gray-50/30")}>
                              ...
                              <td className="px-2 py-1 text-[11px] text-gray-500 max-w-[140px]">
                                {o.note ? <span className="bg-slate-100 text-slate-800 font-medium border border-slate-300 px-1.5 py-0.5 rounded text-[11px]" title={o.note}>{o.note.length > 20 ? o.note.slice(0, 20) + "…" : o.note}</span> : ""}
                              </td>
